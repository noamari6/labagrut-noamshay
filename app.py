...
app = Flask(__name__)
# Enable CORS so that frontend pages hosted on different domains (e.g. GitHub Pages)
# can make requests to this API. Without this, browsers will block cross-origin requests.
CORS(app)
